...
| 6. O sistema **faz uma estimativa da duração da tarefa.** e valida e apresenta os dados ao colaborador de organização, pedindo que os confirme.   		 |**... estima o custo da Tarefa?**  	 |**RegistoTarefa** | **IE: RegistoTarefa contém o registo de todas as tarefas, logo conhece todas as Tarefas.**  |
||	... valida os dados da Tarefa (validação local)? | Tarefa |              IE: possui os seus próprios dados.|  	
